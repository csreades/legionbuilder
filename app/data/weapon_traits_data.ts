...
export const weaponTraitsData: WEAPON_TRAIT_INFO[] = [
	...
	{
		name: "Armourbane",
		tooltip: "Vehicles, Super-Heavy Vehicles, Knights & Titans must reroll successful saves",
		description: [],
	},
	{
		name: "Anti-tank",
		tooltip: "AP 0 vs Infantry & Cavalry",
		description: [],
	},
	{
		name: "Assault",
	...
	{
		name: "Co-axial",
		tooltip: "Must target same detachment as the weapon it is attached to",
		description: [],
	},
	{
	...
	{
		name: "Light",
		tooltip: "Vehicles, Super-heavy Vehicles, Knights & Titans ignore hits",
		description: [],
	},
	{
		name: "Light AT",
		tooltip: "AP0 vs Vehicles, Super-heavy Vehicles, Knights & Titans",
		description: [],
	},
	{
		name: "Limited",
	...
	{
		name: "Neutron Flux",
		tooltip: "Armourbane & Shred vs models with Cybernetica Cortex special rule",
		description: [],
	},
	{
		name: "Point Defence",
	...
	{
		name: "Psi",
		tooltip: "Bypass Invulnerable Saves, Cover Saves, Ion Shields & Void Shields.",
		description: [],
	},
	{
		name: "Quake",
