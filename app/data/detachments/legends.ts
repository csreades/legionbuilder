...
export const legends: DETACHMENT[] = [
		...
		upgrade_options: [
			{
				name: "Tank Commander",
				unit_ref: 2033,
				options: [{ number: 1, cost: 0, size: 0, break_strength: 0, required: true }],
			},
		],
		loadout_options: [
			{
	...
	},
	{
		...
		loadout_options: [
			{
				location: "Weapons",
				options: [{ name: "Plasma mortar and mauler bolt cannons", cost: 0 }],
				required: 4,
			},
		],
		datasheet_info: [],
	...
	},
	{
		...
		dataslate_loadout: [
			{
				text_option: ["Exo-planar bombard and Irradiation engine"],
			},
		],
		upgrade_options: [],
		loadout_options: [
	...
	{
		id: 7068,
		name: "Legate Dracosan Transport",
		faction: FACTION.solar,
		subfaction: null,
		allegiance: null,
		unique: true,
		...
		dataslate_loadout: [
			{
				text_option: ["Hull Mounted demolisher cannon"],
			},
		],
		upgrade_options: [],
		loadout_options: [
			{
				location: "Hull",
				options: [{ name: "Demolisher Cannon", cost: 0 }],
				required: 1,
			},
		],
		datasheet_info: [],
	...
	{
		id: 7070,
		name: "Auxilia Dracosan Transports",
		faction: FACTION.solar,
		subfaction: null,
		allegiance: null,
		unique: true,
		...
		loadout_options: [
			{
				location: "Pintle",
				options: [{ name: "Multi-laser", cost: 0 }],
				required: 2,
			},
		],
		datasheet_info: [],
		...
		upgrade_options: [
			{
				...
				unit_ref: 2002,
				options: [{ number: 8, cost: 0, size: 8, required: true }],
			},
			{
				name: "Additional Auxiliaries with Flamers",
				unit_ref: 9002,
				options: [{ number: 4, cost: 0, size: 4, required: true }],
			},
		],
		loadout_options: [],
		datasheet_info: [],
	},
	{
		...
		dataslate_loadout: [
			{
				text_option: ["Laser destroyer array"],
			},
		],
		upgrade_options: [],
		loadout_options: [
			{
				location: "Main",
				options: [{ name: "Laser destroyer array", cost: 0 }],
				required: 8,
			},
		],
		datasheet_info: [],
	...
	},
	{
		...
		loadout_options: [
			{
				location: "Main",
				options: [{ name: "Mole mortar", cost: 0 }],
				required: 8,
			},
		],
		datasheet_info: [],
	...
	},
	{
		...
		loadout_options: [
			...
			{
				location: "Pintle",
				options: [{ name: "Heavy Stubber", cost: 0 }],
				required: 4,
			},
		],
		datasheet_info: [],
	...
	},
	{
		...
		dataslate_loadout: [
			{
				text_option: ["Neutron beam laser", "Malcador lascannon sponsons"],
			},
		],
		upgrade_options: [],
		loadout_options: [
	...
	{
		id: 7085,
		name: "Veletaris Dracosan Transport",
		faction: FACTION.solar,
		subfaction: null,
		allegiance: ALLEGIANCE.traitor,
		unique: true,
		...
		loadout_options: [
			{
				location: "Hull",
				options: [{ name: "Twin lascannon", cost: 0 }],
				required: 2,
			},
			{
				location: "Pintle",
