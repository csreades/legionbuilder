...
export const astartes: UNIT_DATASHEET[] = [
	...
	},
	{
		...
		unique: false,
		unit_type: { type: UNIT_TYPE.infantry, value: 1 },
		name: "Legion Saturnine Terminator Squad",
		movement: '4"',
		save: 4,
		caf: 3,
		morale: 3,
		wounds: 2,
		weapons: [1080, 1081, 1082, 1083, 1084],
		special_rules: [
			{ name: SpecialRule.veryBulky },
			{ name: SpecialRule.armoured },
			{ name: SpecialRule.invulnerableSave, value: "5+" },
	...
	},
	{
		...
		unique: false,
		unit_type: { type: UNIT_TYPE.vehicle, value: 2 },
		name: "Araknae Weapons Platform",
		movement: "-",
		save: 4,
		caf: -2,
		morale: null,
		wounds: 1,
		weapons: [1089, 1090, 1091],
		special_rules: [{ name: SpecialRule.invulnerableSave, value: "5+" }],
	},
	{
		id: 1047,
		faction: FACTION.astartes,
