...
export const strategicAssets: UNIT_DATASHEET[] = [
	...
	},
	{
		...
		unique: false,
		unit_type: { type: UNIT_TYPE.knight, value: 4 },
		name: "Questoris Mechanicum Knight",
		movement: '8"',
		save: 2,
		caf: 8,
		morale: 2,
		wounds: 3,
		weapons: [4008, 4010, 4011, 4009, 4013],
		special_rules: [
	...
	},
	{
		...
		morale: 2,
		wounds: 4,
		weapons: [4020, 4021, 4022, 4027, 4023],
		special_rules: [
			{ name: SpecialRule.blessedAutosimulacra },
			{ name: SpecialRule.independent },
			{ name: SpecialRule.ionShields, value: "3+" },
	...
	},
	{
		...
		special_rules: [{ name: SpecialRule.voidShields, value: 8 }],
	},
	{
		id: 4011,
		faction: FACTION.strategic,
		...
		special_rules: [
			...
			{ name: SpecialRule.voidShields, value: 8 },
		],
	},
	{
		id: 4012,
